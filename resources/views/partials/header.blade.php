      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
           aria-expanded="false"><i class="fas fa-user"></i> User Account <span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            @else
                <li><a href="{{ route('user.signin') }}"><i class="fas fa-sign-in"></i> Sign in</a></li>
                <li><a href="{{ route('user.signup') }}"><i class="fas fa-user-plu"> </i> Sign up</a></li>
            @endif
          </ul>
        </li>
      </ul>
